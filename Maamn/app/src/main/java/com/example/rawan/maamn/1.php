...
<html>
  ...
  <body>
    ...
    <div id="wrapper" class="container-fluid smooth-transition">
      ...
      <header>
        <div class="container">
          <!-- Branding--><a href="index.html" class="brand"> <img alt="" src="/images/logoCV.png" class="dark-brand"><img alt="" src="images/logo-white.svg" class="light-brand"></a>
          <!-- Menu-->
          <div class="menu"></div>
        </div>
      </header>
      ...
      <section class="slider">
        <ul class="slides">
          ...
          <li class="slide">
            <!-- Background-->
            <div class="hero fs">
              <div style="background-image: url(images/polygon.jpg);" class="bg parallax"></div>
              <div class="container text-center offset-top">
                <!-- Content-->
                <div class="content">
                  <h2 class="lg">Forever viewing source codes</h2>
                </div>
              </div>
            </div>
          </li>
          ...
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <div class="title-block">
                ...
                <h5>We expand your possibilities</h5>
              </div>
      ...
      <footer>
        <div class="container content">
          <div class="row">
            <!-- Contact info-->
            <div class="col-md-2"> 
              <p>P (+966) 0 123 456 78<br>F (+966) 0 123 456 78<br>M <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="83cbe6efefecc3c0ece7e6d5eae6f4ade0ecee">[email&#160;protected]</a></p>
            </div>
            <div class="col-md-2"> 
              <p>Code View Ltd<br>1337 Street<br>12345 Riyadh, Saudi Arabia</p>
            </div>
            <div class="col-md-8 text-right">
              ...
              <!-- Copyright message-->
              <div class="copyright">2019 &copy; Code View Ltd. All rights reserved. </div>
            </div>
          </div>
        </div>
      </footer>
    </div>
    <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="js/assets/bootstrap.js"></script>
